    ...
    <div className="min-h-screen top-12 mb-12 bg-gradient-to-br from-purple-100 via-purple-50 to-yellow-100 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 right-20 opacity-30">
        <svg width="100" height="100" viewBox="0 0 100 100" className="text-purple-300">
          <path d="M20 50 Q50 20 80 50 Q50 80 20 50" fill="none" stroke="currentColor" strokeWidth="3"/>
      ...
      <div className="absolute bottom-20 right-1/4 opacity-40">
        <svg width="80" height="60" viewBox="0 0 80 60" className="text-purple-200">
          <path d="M10 50 Q20 10 40 30 Q60 10 70 50" fill="none" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/>
        </svg>
      </div>
            ...
            <div className="relative">
              <div className="w-24 h-24 bg-white rounded-2xl shadow-lg flex items-center justify-center transform rotate-3 hover:rotate-0 transition-transform duration-300">
                <svg width="48" height="48" viewBox="0 0 48 48" className="text-purple-600">
                  <path d="M12 8h24c2.2 0 4 1.8 4 4v24c0 2.2-1.8 4-4 4H12c-2.2 0-4-1.8-4-4V12c0-2.2 1.8-4 4-4z" fill="none" stroke="currentColor" strokeWidth="2"/>
      ...
      <div className="absolute bottom-0 left-0 w-40 h-40 opacity-20">
        <svg viewBox="0 0 100 100" className="text-purple-300 w-full h-full">
          ...
          <path d="M15 75 Q30 60 45 80 Q60 55 85 85" fill="none" stroke="currentColor" strokeWidth="2"/>
        </svg>
      </div>
    </div>
  );
