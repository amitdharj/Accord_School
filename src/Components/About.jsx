  ...
  return (
    <div className="bg-gradient-to-br from-purple-50 to-purple-100 py-16 px-4 relative overflow-hidden">
      ...
      <div className="absolute top-8 left-8 opacity-60">
        <svg className="w-16 h-16 text-purple-400 transform rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4"/>
        </svg>
      </div>
      
      <div className="absolute top-12 right-12 opacity-60">
        <svg className="w-12 h-12 text-purple-400 transform -rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Our Business Partners don't just take the name, they also take our <span className="font-semibold text-gray-800">pedagogy- PANKEMIND</span>, guidelines to teach, 
              ...
              <p className="text-gray-600 leading-relaxed">
                <span className="font-semibold text-gray-800">Secret to Success is Service and Support.</span> We provide pre-opening and operational support apart from the regular 
                support that is given additional to all systems and process.
              </p>
            </div>
