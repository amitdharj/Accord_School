      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-700 text-lg max-w-5xl mx-auto leading-relaxed">
            Accord Public School is your experienced trusted partner in
            providing exceptional early education for your child. Here's why
            Accord stands out as the preferred choice for parents seeking the
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="relative mb-6">
                ...
                <div className="absolute -top-2 -left-2 text-purple-500 text-2xl">
                  ⭐
                </div>
              </div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Fostering all-round development through a balanced blend of
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="relative mb-6">
                ...
                <div className="absolute -bottom-2 -right-2 text-pink-500 text-2xl">
                  🌸
                </div>
              </div>
              <h3 className="text-2xl font-bold text-purple-700 mb-3">
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="relative mb-6">
                ...
                <div className="absolute -bottom-3 -left-3 text-blue-500 text-2xl">
                  🌈
                </div>
              </div>
              <h3 className="text-2xl font-bold text-purple-700 mb-3">
